...
def categorize_transaction(
    ...
    if not amount or amount < 0 or (amount > 0 and amount < 100000):
        ...
        # Food & Restaurants
        food_keywords = [
            'starbucks', 'evos', 'cbon', 'texas', 'kfc', 'mcdonald',
            'restaurant', 'кафе', 'ресторан', 'coffe', 'coffee',
            'lavash', 'osh', 'palov', 'food'
        ]
        ...
        # Transport
        transport_keywords = [
            'taxi', 'yandex', 'metro', 'bus', 'такси', 'метро',
            'transport', 'uber', 'bolt'
        ]
        ...
        # Shopping & Retail
        shopping_keywords = [
            'makro', 'korzinka', 'market', 'supermarket', 'olcha', 'uzum',
            'clothing', 'clothes', 'одежда', 'обувь', 'electronics'
        ]
        ...
        # Health & Medicine
        health_keywords = [
            'pharmacy', 'аптека', 'hospital', 'больница', 'doctor', 'врач',
            'medicine', 'лекарство', 'clinic', 'клиника'
        ]
        ...
        bills_keywords = [
            ...
            'электричество', 'газ', 'вода', 'интернет', 'телефон',
        ...
        entertainment_keywords = [
            'cinema', 'movie', 'theater', 'concert', 'game', 'кино',
            'театр', 'концерт', 'развлечение', 'entertainment'
        ]
        ...
        # Education
        education_keywords = [
            'school', 'university', 'course', 'training', 'education',
            'школа', 'университет', 'курс', 'образование', 'обучение'
        ]
        ...
        bank_keywords = [
            'bank', 'комиссия', 'обслуживание', 'fee', 'commission',
            'перевод', 'вывод', 'withdraw'
        ]
...
async def transform_transaction(
    ...
    try:
        ...
        raw_merchant = (
            raw_data.get('merchant') or 
            raw_data.get('Merchant')
        )
        if raw_merchant:
        ...
        print(f"✅ Transformed transaction {transaction.id}: {cleaned_merchant} → {cleaned_category}")
        return True
